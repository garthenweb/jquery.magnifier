(function ($) {
    ...
    $.fn.magnifier = function(options) {
        ...
        function changePos(ev) {
            ...
            var offsetX = Math.max(0, Math.min(elWidth - ppzrWidth, ev.clientX - wrapperOffset.top));
            var offsetY = Math.max(0, Math.min(elHeight - ppzrHeight, ev.clientY - wrapperOffset.left));
